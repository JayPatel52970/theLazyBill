<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="billOfSupply.aspx.cs" Inherits="theLazyBill.WebForm2" %>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-header">
                    <h3 class="card-title" style="font-weight: bolder">Bill of supply</h3>
                </div>
            </div>
        </div>
        <div class="row">
